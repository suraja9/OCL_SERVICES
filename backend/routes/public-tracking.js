...
const buildMedicineTrackingSummary = async (medicineBooking) => {
  ...
  const trackingSummary = {
    metadata: {
      ...
      totalWeight: shipmentData?.actualWeight || null,
...
const buildCustomerBookingTrackingSummary = async (customerBooking) => {
  ...
  const trackingSummary = {
    metadata: {
      ...
      totalWeight: shipmentData?.weight || customerBooking.actualWeight || customerBooking.chargeableWeight || null,
  ...
  try {
    ...
    const trackingSummary = {
      metadata: {
        ...
        totalWeight: shipmentData?.actualWeight || shipmentData?.chargeableWeight || invoiceData?.chargeableWeight || null,
